...
from jax.experimental.stax import Conv, Dense, MaxPool, Relu, Flatten, LogSoftmax, BatchNorm
...
class OmniglotMAML(MAML):
    ...
    def _get_model(self):
        ...
        for l in self.network_layers:
            ...
            #layers.append(MaxPool(window_shape=(2, 2)))
        
        # make jax stax object
        model = softmax(stax.serial(*layers))
