...
tmux kill-session -t pq_importance_maml_exp
tmux kill-session -t pq_sample_delta
...
tmux new -s pq_importance_maml_exp -d
tmux new -s pq_sample_delta -d
...
tmux send-keys -t "standard_maml_exp" "python main.py -base_config image_configs/base_config.yaml -config image_configs/maml_config.yaml" C-m
tmux send-keys -t "pq_epsilon_maml_exp" "python main.py -base_config image_configs/base_config.yaml -config image_configs/pq_maml_config.yaml" C-m
tmux send-keys -t "pq_sample_maml_exp" "python main.py -base_config image_configs/base_config.yaml -config image_configs/pq_sample_maml_config.yaml" C-m
tmux send-keys -t "pq_importance_maml_exp" "python main.py -base_config image_configs/base_config.yaml -config image_configs/pq_importance_maml_config.yaml" C-m
tmux send-keys -t "pq_sample_delta" "python main.py -base_config image_configs/base_config.yaml -config image_configs/pq_sample_delta.yaml" C-m
